...
(function (global) {
    ...
    //设置全局变量对象uoko
    var uoko = global.uoko = global.uoko || {};

    /**
     * 关于cookie的操作
     * @return {Object} 方法对象
     */
    uoko.cookie = (function () {
        var domain = ".uoko.com";
        var obj = {
            /**
             * 获取cookie值
             * @param  {String} cookie name
             * @return {[type]} 返回cookie值
             */
            get: function (name) {
            ...
            set: function (name, value) {
                var Days = 365;//默认过期时间为365天
                var exp = new Date();
                exp.setTime(exp.getTime() + Days * 24 * 60 * 60 * 1000);
                document.cookie = name + "=" + escape(value) + ";expires=" + exp.toGMTString() + ";domain=" + domain + ";path=/";//domain默认为.uoko.com; path默认为/
            },
            /**
             * 删除某条cookie
             * @param  {String} cookie name
            ...
            remove: function (name) {
                ...
                if (cval != null) {
                    document.cookie = name + "=" + cval + ";expires=" + exp.toGMTString() + ";domain=" + domain + ";path=/";//domain默认为.uoko.com; path默认为/
                }
            },
            /**
             * 删除所有cookie
            ...
            removeAll: function () {
                ...
                if (keys) {
                    for (var i = keys.length; i--;) {
                        document.cookie = keys[i] + '=0;expires=' + new Date(0).toUTCString() + ";domain=" + domain + ";path=/";//domain默认为.uoko.com; path默认为/
                    }
                }
            }
        }
